...
public class NetworkExceptionCode extends cn.featherfly.common.exception.SimpleLocalizedExceptionCode {
    ...
    public static NetworkExceptionCode createNoRegisteredClientCode(java.lang.String clientId) {
        return new NetworkExceptionCode(10000, "no_registered_client", new Object[] { clientId });
    }
    ...
    public static NetworkExceptionCode createConnectFailureCode(cn.featherfly.network.NetworkAddress networkAddress) {
        return new NetworkExceptionCode(10001, "connect_failure", new Object[] { networkAddress });
    }
    ...
    public static NetworkExceptionCode createNotConnectedCode(cn.featherfly.network.NetworkAddress networkAddress) {
        return new NetworkExceptionCode(10002, "not_connected", new Object[] { networkAddress });
    }
     ...
     */
    public static NetworkExceptionCode createSerializeErrorCode(java.lang.String className,
            java.lang.String errorMessage) {
        return new NetworkExceptionCode(10003, "serialize_error", new Object[] { className, errorMessage });
    }
     ...
     */
    public static NetworkExceptionCode createDeserializeErrorCode(java.lang.String className,
            java.lang.String errorMessage) {
        return new NetworkExceptionCode(10004, "deserialize_error", new Object[] { className, errorMessage });
    }
