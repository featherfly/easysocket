 ...
 * @author zhongj
 */
public class NettyClientDisconnectEvent
        implements cn.featherfly.network.ClientDisconnectEvent {
     ...
     * @param remoteAddress
     */
    protected NettyClientDisconnectEvent(NetworkAddress remoteAddress) {
        super();
